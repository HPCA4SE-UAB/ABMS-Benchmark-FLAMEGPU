...
int h_tex_xmachine_message_agentCooperate_message_offset;
...
void person_play(cudaStream_t &stream){
	...
	size_t tex_xmachine_message_agentCooperate_message_byte_offset;    
	gpuErrchk( cudaBindTexture(&tex_xmachine_message_agentCooperate_message_byte_offset, tex_xmachine_message_agentCooperate_message, d_agentCooperates->message, sizeof(int)*xmachine_message_agentCooperate_MAX));
	h_tex_xmachine_message_agentCooperate_message_offset = (int)tex_xmachine_message_agentCooperate_message_byte_offset / sizeof(double);
	gpuErrchk(cudaMemcpyToSymbol( d_tex_xmachine_message_agentCooperate_message_offset, &h_tex_xmachine_message_agentCooperate_message_offset, sizeof(int)));
	//bind pbm start and end indices to textures
  ...
  h_tex_xmachine_message_agentCooperate_pbm_end_or_count_offset = (int)tex_xmachine_message_agentCooperate_pbm_end_or_count_byte_offset / sizeof(int);
	...
	gpuErrchk( cudaUnbindTexture(tex_xmachine_message_agentCooperate_message));
	//unbind pbm indices
