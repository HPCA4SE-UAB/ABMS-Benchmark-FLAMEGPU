...
__FLAME_GPU_FUNC__ int cooperate (xmachine_memory_person *agent, 
                                  xmachine_message_agentLocation_list *agentLocation_messages, 
                                  xmachine_message_agentLocation_PBM *partition_matrix, 
     ...
     int cooperate_;
     int message0 = 123456789;  // Before a char array "0123456789"
     int message1 = 123456789;
     int message2 = 123456789;
     int message3 = 123456789;
     int message4 = 123456789;
     int message5 = 123456789;
     int message6 = 123456789;
     int message7 = 123456789;
     int message8 = 123456789;  // Before a char array "0123456789"
     int message9 = 123456789;
     int message10 = 123456789;
     int message11 = 123456789;
     int message12 = 123456789;
...
__FLAME_GPU_FUNC__ int play (xmachine_memory_person *agent, 
                             xmachine_message_agentCooperate_list *agentCooperate_messages, 
                             xmachine_message_agentCooperate_PBM *partition_matrix, 
                             RNG_rand48 *rand48)
     {
     /* //Template for input message itteration
      * 
